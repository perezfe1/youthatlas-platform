...
<table style={{width: '100%', borderCollapse: 'collapse', marginTop: '1rem', marginBottom: '1.5rem'}}>
  <thead>
    <tr style={{borderBottom: '2px solid #E5E7EB', textAlign: 'left'}}>
      <th style={{padding: '0.75rem 1rem', fontSize: '0.875rem', fontWeight: 600}}>Term</th>
      <th style={{padding: '0.75rem 1rem', fontSize: '0.875rem', fontWeight: 600}}>Typical Meaning</th>
    </tr>
  </thead>
  <tbody>
    <tr style={{borderBottom: '1px solid #F3F4F6'}}>
      <td style={{padding: '0.75rem 1rem', fontSize: '0.875rem'}}>Full scholarship</td>
      <td style={{padding: '0.75rem 1rem', fontSize: '0.875rem'}}>Tuition only</td>
    </tr>
    <tr style={{borderBottom: '1px solid #F3F4F6'}}>
      <td style={{padding: '0.75rem 1rem', fontSize: '0.875rem'}}>Full award / full funding</td>
      <td style={{padding: '0.75rem 1rem', fontSize: '0.875rem'}}>Tuition + stipend + usually travel</td>
    </tr>
    <tr style={{borderBottom: '1px solid #F3F4F6'}}>
      <td style={{padding: '0.75rem 1rem', fontSize: '0.875rem'}}>Stipend</td>
      <td style={{padding: '0.75rem 1rem', fontSize: '0.875rem'}}>Monthly living allowance</td>
    </tr>
    <tr style={{borderBottom: '1px solid #F3F4F6'}}>
      <td style={{padding: '0.75rem 1rem', fontSize: '0.875rem'}}>Grant</td>
      <td style={{padding: '0.75rem 1rem', fontSize: '0.875rem'}}>Funds for a specific project or purpose</td>
    </tr>
    <tr style={{borderBottom: '1px solid #F3F4F6'}}>
      <td style={{padding: '0.75rem 1rem', fontSize: '0.875rem'}}>Fellowship</td>
      <td style={{padding: '0.75rem 1rem', fontSize: '0.875rem'}}>Usually includes stipend + sometimes tuition</td>
    </tr>
    <tr style={{borderBottom: '1px solid #F3F4F6'}}>
      <td style={{padding: '0.75rem 1rem', fontSize: '0.875rem'}}>Bursary</td>
      <td style={{padding: '0.75rem 1rem', fontSize: '0.875rem'}}>Need-based support, often for specific costs</td>
    </tr>
    <tr style={{borderBottom: '1px solid #F3F4F6'}}>
      <td style={{padding: '0.75rem 1rem', fontSize: '0.875rem'}}>Waiver</td>
      <td style={{padding: '0.75rem 1rem', fontSize: '0.875rem'}}>Fee or tuition reduction, not additional funds</td>
    </tr>
    <tr style={{borderBottom: '1px solid #F3F4F6'}}>
      <td style={{padding: '0.75rem 1rem', fontSize: '0.875rem'}}>Honorarium</td>
      <td style={{padding: '0.75rem 1rem', fontSize: '0.875rem'}}>One-time payment for a specific contribution</td>
    </tr>
  </tbody>
</table>
